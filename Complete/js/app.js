...
// Add states (ready + instructions, game screen when running)

// Add baddies (spawn on side of screen)
// Have to jump over baddies (collision which kills player)
// You lose screen (show score)
...
function gameOver(lives) {
    if (lives == 0) {
        ...
        // Done so enemies hitting wall don't add to displayed points
        // This wouldn't work if we were saving the total score,
        // since the score value still changes
        var newScore = score;
        scoreText.destroy();
